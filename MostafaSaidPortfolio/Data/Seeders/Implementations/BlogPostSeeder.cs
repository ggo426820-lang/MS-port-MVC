...
public class BlogPostSeeder : ISeeder
{
    public async Task SeedAsync(NpgsqlConnection connection)
    {
        ...
        await connection.ExecuteAsync(@"
            ...
            (""Id"", ""Title"", ""Content"", ""Summary"", ""Slug"", ""MetaTitle"", ""MetaDescription"", ""Status"", ""PublishedAt"", ""ViewCount"", ""ReadingTime"", ""IsFeatured"", ""CategoryId"", ""CreatedAt"", ""CreatedBy"")
            VALUES
                (gen_random_uuid(), 'Getting Started with ASP.NET Core', @content1, 'An introduction to building web apps with ASP.NET Core — setup, structure, and your first endpoint.', 'getting-started-with-aspnet-core', 'Getting Started with ASP.NET Core', 'Learn the basics of ASP.NET Core, a cross-platform framework for building modern web applications.', 1, NOW(), 245, 5, TRUE, @devCategoryId, NOW(), 'system'),
                (gen_random_uuid(), 'UI/UX Design Principles Every Developer Should Know', @content2, 'Core principles of UI/UX design that help developers create better user experiences.', 'ui-ux-design-principles', 'UI/UX Design Principles', 'Explore the fundamental principles of UI/UX design for better, more usable interfaces.', 1, NOW(), 186, 4, FALSE, @designCategoryId, NOW(), 'system'),
                (gen_random_uuid(), 'PostgreSQL + Dapper: A Powerful Combination', @content3, 'Why PostgreSQL and Dapper make an excellent pairing for .NET applications that need performance and control.', 'postgresql-dapper-powerful-combination', 'PostgreSQL + Dapper: A Powerful Combination', 'Explore how to use PostgreSQL and Dapper together for high-performance .NET data access.', 1, NOW(), 312, 8, FALSE, @devCategoryId, NOW(), 'system')
